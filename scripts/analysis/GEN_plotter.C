...
//
//
//   The purpose of this script is to make the plots for the
//   final GEN analysis. The form factor results must be put
//   into the arrays below from the analysis scripts. It will
//   then plot the data points along with other world data.
//
//////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////
...
//double GEGM_new[npoints_new] = {0,0,0};
//double GEGM_stat_err_new[npoints_new] = {0,0,0};
//double GEGM_sys_err_new[npoints_new] = {0,0,0};
...
//double GE_new[npoints_new] = {0,0,0};
//double GE_stat_err_new[npoints_new] = {0,0,0};
//double GE_sys_err_new[npoints_new] = {0,0,0};
